...
async fn list_agent_logos(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .list_agent_logos_for_user(&user.id)
            .await
...
async fn list_management_agents(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .list_management_agents_for_user(&user.id)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn health_check_by_id(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .health_check_agent_by_id_for_user(&user.id, &id)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn create_custom(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .create_custom_agent_for_user(&user.id, req)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn update_custom(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .update_custom_agent_for_user(&user.id, &id, req)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn delete_custom(
    ...
    state
        .service
        .delete_custom_agent_for_user(&user.id, &id)
        .await
        .map_err(agent_error_to_api_error)?;
...
async fn set_agent_enabled(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .set_agent_enabled_for_user(&user.id, &id, req.enabled)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn get_agent_overrides(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .get_agent_overrides_for_user(&user.id, &id)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
...
async fn set_agent_overrides(
    ...
    Ok(Json(ApiResponse::ok(
        state
            .service
            .set_agent_overrides_for_user(&user.id, &id, req)
            .await
            .map_err(agent_error_to_api_error)?,
    )))
}
