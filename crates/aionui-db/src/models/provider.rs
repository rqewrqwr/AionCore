...
///
/// JSON fields (models, capabilities, model_protocols, model_capabilities,
/// model_enabled, model_health, bedrock_config) are stored as TEXT in SQLite and
...
pub struct Provider {
    ...
    /// JSON object: model_id -> capability array.
